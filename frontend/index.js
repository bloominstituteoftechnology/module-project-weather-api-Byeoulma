async function moduleProject4() {
  ...
  let getWidget = document.querySelector('#weatherWidget');
  getWidget.style.display = 'none';
  
  let dropEvent = document.querySelector('#citySelect');
  // Add Event
  dropEvent.addEventListener('change', async evt => {
    ...
    try {
      ...
      console.log('Requested failed. Please try again.')
    }
});
